...
func (m *MockStore) AddAcountBalance(ctx context.Context, arg db.AddAcountBalanceParams) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddAcountBalance", ctx, arg)
...
func (mr *MockStoreMockRecorder) AddAcountBalance(ctx, arg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddAcountBalance", reflect.TypeOf((*MockStore)(nil).AddAcountBalance), ctx, arg)
}
